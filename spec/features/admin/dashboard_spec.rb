...
RSpec.describe 'Admin Dashboard' do
  describe 'As an Admin' do
    before :each do
      ...
      @address_1 = @m_user.addresses.create(nickname: "work", address: '123 Main St', city: 'Marianna', state: 'Colorado', zip: 34567)
      @address_2 = @m_user.addresses.create(nickname: "mom", address: '123 Main St', city: 'Portland', state: 'Texas', zip: 34567)
      @order_1 = @m_user.orders.create!(status: "packaged", address_id: @address_1.id)
      @order_2 = @m_user.orders.create!(status: "pending", address_id: @address_2.id)
      @order_3 = @m_user.orders.create!(status: "cancelled", address_id: @address_2.id)
