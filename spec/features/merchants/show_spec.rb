...
RSpec.describe 'Merchant Show Page' do
  describe 'As a visitor' do
    before :each do
      ...
      @address_1 = @user_1.addresses.create(nickname: "work", address: '123 Main St', city: 'Marianna', state: 'CO', zip: 34567)
      @address_2 = @user_2.addresses.create(nickname: "work", address: '123 Main St', city: 'Portland', state: 'OR', zip: 34567)
