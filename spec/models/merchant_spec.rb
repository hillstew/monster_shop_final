...
RSpec.describe Merchant do
  ...
  describe 'Instance Methods' do
    before :each do
      ...
      @address_1 = @user_1.addresses.create(nickname: "work", address: '123 Main St', city: 'Marianna', state: 'Colorado', zip: 34567)
      @address_2 = @user_2.addresses.create(nickname: "work", address: '123 Main St', city: 'Portland', state: 'Oregon', zip: 34567)
    ...
    it '.distinct_cities' do
      expect(@megan.distinct_cities).to eq(['Marianna, Colorado', 'Portland, Oregon'])
    end
